  ...
  return (
    <div className= "container" id="proyects">
      ...
      <p className= {isAnimating ? `${styles.intro_text} ${styles.animation}` : styles.intro_text}>
        ...
        les invito a ver algunos de los proyectos personales más destacados 
        en los que he estado trabajando desde que comencé este camino como Frontend developer:
      </p>
